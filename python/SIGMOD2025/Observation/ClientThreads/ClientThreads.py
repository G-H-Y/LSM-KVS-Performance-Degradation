...
def Draw_Throughput_CCs(LOG_list, report_list, iostat_list,cpustat_list, path_list,figpath, figname,workload, cache,core, arrivalrate, bkthreads):
    ...
    figtitle_list = ["Client Threads = 1", "Client Threads = 10", "Client Threads = 50", "Client Threads = 70", "Client Threads = 100"]
...
if __name__ == '__main__':
    ...
    for workload in workloads:
        ...
        path_list = [
            ...
            EXP_PATH + "CT70_{}_MT2_cores128_workloada-{}-zipfian_r1/".format(bkthreads, workload),
