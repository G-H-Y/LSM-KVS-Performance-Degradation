...
if __name__ == '__main__':
    ...
    for workload in workloads:
        path_list = [
            ...
            # EXP_PATH + "cores128_{}_MT2_Cache256MB_workloada-{}-zipfian_r1/".format(bkthreads, workload),
        ]
        LOG_list.clear()
        report_list.clear()
        iostat_list.clear()
        ...
        figname = "{}-LessCPUCores-CPUCores".format(workload)
