...
from common import Draw_TptYCSB_RTWSs_SlowStop_2ax, Draw_YCSB_RTWSs_SlowStop_ax
...
def Draw_Throughput_CCs(LOG_list, report_list, iostat_list,cpustat_list, path_list,figpath, figname,workload, cores, arrivalrate, bkthreads, cache, distribution):
    ...
    figtitle_list = ["BC=256MB", "BC=1GB","BC=10GB",
                     "BC=50GB", "BC=100GB", "OSCache"]
    plt.rcParams["font.family"] = "Times New Roman"
...
if __name__ == '__main__':
    ...
    dir = "{}_{}_ip{}".format(distribution, bkthreads, ip)
    # dir = "{}_pinl0_{}_ip{}".format(distribution, bkthreads, ip)
    workloads = ["70w30r","50w50r", "30w70r", "10w90r"]
    # workloads = ["90w10r"]
    ...
    for workload in workloads:
        path_list = [
            ...
            EXP_PATH + "BlockCache256MB_{}_MT2_cores{}_AA30K_workloada-{}-{}_r1/".format(bkthreads,cores, workload, distribution),
            EXP_PATH + "BlockCache1GB_{}_MT2_cores{}_AA30K_workloada-{}-{}_r1/".format(bkthreads,cores, workload, distribution),
            EXP_PATH + "BlockCache10GB_{}_MT2_cores{}_AA30K_workloada-{}-{}_r1/".format(bkthreads,cores, workload, distribution),
            EXP_PATH + "BlockCache50GB_{}_MT2_cores{}_AA30K_workloada-{}-{}_r1/".format(bkthreads,cores, workload, distribution),
            EXP_PATH + "BlockCache100GB_{}_MT2_cores{}_AA30K_workloada-{}-{}_r1/".format(bkthreads,cores, workload, distribution),
            EXP_PATH + "OSCache_{}_MT2_cores{}_AA30K_workloada-{}-{}_r1/".format(bkthreads,cores, workload, distribution),
        ]
        LOG_list.clear()
        report_list.clear()
        iostat_list.clear()
